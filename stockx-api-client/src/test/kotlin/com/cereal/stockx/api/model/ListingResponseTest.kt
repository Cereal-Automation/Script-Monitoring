...
class ListingResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of ListingResponse
        //val modelInstance = ListingResponse()
        ...
        // to test the property `payout` - The payout object that contains the payout details and any adjustments like selling fees, shipping fees, taxes, etc.
        should("test payout") {
            // uncomment below to test the property
            //modelInstance.payout shouldBe ("TODO")
        }

        // to test the property `lastOperation` - An object containing the the details of the operation.
        should("test lastOperation") {
            // uncomment below to test the property
            //modelInstance.lastOperation shouldBe ("TODO")
        }

        // to test the property `initiatedShipments` - Details about manifests associated with the listing
