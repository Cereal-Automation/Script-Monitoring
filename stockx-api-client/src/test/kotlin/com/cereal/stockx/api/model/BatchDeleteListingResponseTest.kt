...
class BatchDeleteListingResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of BatchDeleteListingResponse
        //val modelInstance = BatchDeleteListingResponse()
