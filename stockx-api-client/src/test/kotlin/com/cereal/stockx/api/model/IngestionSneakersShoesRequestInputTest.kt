...
class IngestionSneakersShoesRequestInputTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of IngestionSneakersShoesRequestInput
        //val modelInstance = IngestionSneakersShoesRequestInput()
        ...
        // to test the property `colorway` - The combinations of colors in which the product is designed. Ex VIOLET ORE/MEDIUM ASH-BLACK-MUSLIN-BURGUNDY CRUSH.
        should("test colorway") {
            // uncomment below to test the property
            //modelInstance.colorway shouldBe ("TODO")
        }

        // to test the property `gtin` - The products global trade item number. Length must be 8, 12, 13, 14 or 18.
        should("test gtin") {
            // uncomment below to test the property
        ...
        // to test the property `dimensions` - A string of the dimensions of the product. @example \"2/\"x4/\"x6/\"\"
