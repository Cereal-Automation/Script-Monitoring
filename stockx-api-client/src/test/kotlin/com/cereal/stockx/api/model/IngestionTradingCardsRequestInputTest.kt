...
class IngestionTradingCardsRequestInputTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of IngestionTradingCardsRequestInput
        //val modelInstance = IngestionTradingCardsRequestInput()
