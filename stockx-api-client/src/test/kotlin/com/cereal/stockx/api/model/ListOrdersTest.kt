...
class ListOrdersTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of ListOrders
        //val modelInstance = ListOrders()
        ...
        // to test the property `payout` - Details about payout for the listing
        should("test payout") {
            // uncomment below to test the property
            //modelInstance.payout shouldBe ("TODO")
        }

        // to test the property `initiatedShipments` - An object containing details about the customer initiated shipment
