...
class BatchUpdateListingResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of BatchUpdateListingResponse
        //val modelInstance = BatchUpdateListingResponse()
        ...
        // to test the property `completedAt` - When this batch was last completed in UTC.  Represented as ISO 8601 format like 2021-11-09T12:44:31.000Z
        should("test completedAt") {
            // uncomment below to test the property
            //modelInstance.completedAt shouldBe ("TODO")
        }

        // to test the property `createdAt` - When this batch was last created in UTC.  Represented as ISO 8601 format like 2021-11-09T12:44:31.000Z
