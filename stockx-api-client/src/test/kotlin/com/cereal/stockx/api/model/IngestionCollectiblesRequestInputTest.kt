...
class IngestionCollectiblesRequestInputTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of IngestionCollectiblesRequestInput
        //val modelInstance = IngestionCollectiblesRequestInput()
