 ...
 * @param colorway The combinations of colors in which the product is designed. Ex VIOLET ORE/MEDIUM ASH-BLACK-MUSLIN-BURGUNDY CRUSH.
 * @param gtin The products global trade item number. Length must be 8, 12, 13, 14 or 18.
 * @param gender The products targeted gender.
 ...
 * @param dimensions A string of the dimensions of the product. @example \"2/\"x4/\"x6/\"\"
 * @param weight The weight of the product.
 * @param material Brand listed materials.
 * @param productURL Official third party product URL.
 */


data class IngestionSneakersShoesRequestInput (
    ...
    /* The combinations of colors in which the product is designed. Ex VIOLET ORE/MEDIUM ASH-BLACK-MUSLIN-BURGUNDY CRUSH. */
    @Json(name = "colorway")
    val colorway: kotlin.String,

    /* The products global trade item number. Length must be 8, 12, 13, 14 or 18. */
    @Json(name = "gtin")
    val gtin: kotlin.String,

    /* The products targeted gender. */
    @Json(name = "gender")
    val gender: kotlin.String,

    /* The Style Code for the product  @example \"M990BK5\" */
    @Json(name = "styleCode")
    val styleCode: kotlin.String,
    ...
    /* A string of the dimensions of the product. @example \"2/\"x4/\"x6/\"\" */
