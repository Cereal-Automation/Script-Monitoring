...
class BaseConfigurationTest {
    ...
    @Test
    fun `test monitorInterval returns configured value`() = runTest {
    ...
    @Test
    fun `test monitorInterval returns null when not configured`() = runTest {
    ...
    @Test
    fun `test KEY_MONITOR_INTERVAL constant value`() = runTest {
