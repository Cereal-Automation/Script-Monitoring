...
class FilteredNewItemMonitorStrategyTest {
    ...
    @Test
    fun `no filters configured passes through baseline message`() = runTest {
        val item = newItem()
        coEvery { baselineStrategy.shouldNotify(item, null) } returns baselineMessage

        val strategy = FilteredNewItemMonitorStrategy(
    ...
    @Test
    fun `baseline returns null always returns null regardless of filters`() = runTest {
    ...
    @Test
    fun `MATCH_ANY keyword matches returns baseline message`() = runTest {
    ...
    @Test
    fun `MATCH_ANY author matches returns baseline message`() = runTest {
    ...
    @Test
    fun `MATCH_ANY category matches returns baseline message`() = runTest {
    ...
    @Test
    fun `MATCH_ANY nothing matches returns null`() = runTest {
    ...
    @Test
    fun `MATCH_ALL all filters match returns baseline message`() = runTest {
        val item = newItem(name = "Kotlin Tutorial", author = "Alice", categories = listOf("tech"))
        coEvery { baselineStrategy.shouldNotify(item, null) } returns baselineMessage
    ...
    @Test
    fun `MATCH_ALL only keyword matches missing author returns null`() = runTest {
    ...
    @Test
    fun `MATCH_ALL only keywords configured keyword matches returns baseline message`() = runTest {
        val item = newItem(name = "Kotlin Tutorial")
        coEvery { baselineStrategy.shouldNotify(item, null) } returns baselineMessage
    ...
    @Test
    fun `MATCH_ALL only keywords configured keyword does not match returns null`() = runTest {
    ...
    @Test
    fun `keyword matching in description is case-insensitive`() = runTest {
    ...
    @Test
    fun `author matching is case-insensitive`() = runTest {
        val item = newItem(name = "Some Post", author = "ALICE")
        coEvery { baselineStrategy.shouldNotify(item, null) } returns baselineMessage
    ...
    @Test
    fun `matchAllOnlyAuthorsConfiguredAuthorMatchesReturnsBaseline`() = runTest {
    ...
    @Test
    fun `matchAllOnlyAuthorsConfiguredAuthorDoesNotMatchReturnsNull`() = runTest {
    ...
    @Test
    fun `matchAllOnlyCategoriesConfiguredCategoryMatchesReturnsBaseline`() = runTest {
    ...
    @Test
    fun `matchAllOnlyCategoriesConfiguredCategoryDoesNotMatchReturnsNull`() = runTest {
